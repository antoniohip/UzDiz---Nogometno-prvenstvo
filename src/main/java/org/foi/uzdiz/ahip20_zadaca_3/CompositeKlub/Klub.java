 ...
 * @author NWTiS_2
 */
public class Klub implements Komponenta {
     private List<Komponenta> employeeList = new ArrayList<Komponenta>();
     public String klub;
    public String naziv;
    ...
    {
        for(Komponenta emp:employeeList)
        {
            emp.showEmployeeDetails();
        }
    }

    public Klub(String klub, String naziv) {
        this.klub = klub;
        this.naziv = naziv;
    }
    
       
    public void addEmployee(Komponenta emp)
    {
        employeeList.add(emp);
    }
       
    public void removeEmployee(Komponenta emp)
    {
