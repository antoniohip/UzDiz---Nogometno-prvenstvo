 ...
 * @author NWTiS_2
 */
public class Branici extends PozicijeDecorator {

    private final BrojIgracaPozicije pozicije;

    public Branici(BrojIgracaPozicije pozicije) {
